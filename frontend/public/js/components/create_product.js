...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const headerPath = '/frontend/public/views/components/header_create_product.html';
    const navbarPath = '/frontend/public/views/components/navbar_create_product.html';
    const bodyPath = '/frontend/public/views/components/create_product.html';
    ...
    loadComponent(footerPath, 'footer-placeholder');
            ...
            input.onchange = (e) => {
                ...
                if (file) {
                    ...
                    reader.onload = (event) => {
                        ...
                        document.querySelector('.image-text').textContent = file.name;
                    };
        ...
        document.getElementById('productForm').addEventListener('submit', (e) => {
            ...
            const formData = {
                ...
                tipoPeso: document.getElementById('tipoPeso').value,
