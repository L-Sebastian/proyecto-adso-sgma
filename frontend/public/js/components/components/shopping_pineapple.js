...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const headerPath = '/frontend/public/views/components/components/header.html';
    const navbarPath = '/frontend/public/views/components/components/navbarshopping.html';
    const bodyPath = '/frontend/public/views/components/components/shopping_pineapple.html';
