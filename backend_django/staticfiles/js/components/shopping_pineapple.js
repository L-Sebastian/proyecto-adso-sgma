document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch('/static/views/components/shopping_pineapple.html')
        .then(response => {
...
var productosBase = [
    /* Filtros */
    { id: 'fresas-01',    name: 'Fresas',          price: 12140, unit: 'lb',  vendor: 'Finca el Porvenir',   img: '/static/img/fresas.jpeg',       tipo: 'Fruta'   },
    ...
    { id: 'uva-01',       name: 'Uva Isabella',     price: 5260,  unit: 'lb',  vendor: 'Finca el Indio',      img: '/static/img/uvas.jpeg',         tipo: 'Fruta'   },
    { id: 'naranja-01',   name: 'Naranja Tangelo',  price: 6400,  unit: 'lb',  vendor: 'Finca Imbachi',       img: '/static/img/naranja.jpeg',      tipo: 'Fruta'   },
    { id: 'ciruela-01',   name: 'Ciruela Roja',     price: 3600,  unit: 'lb',  vendor: 'Finca Imbachi',       img: '/static/img/ciruela_roja.jpeg', tipo: 'Fruta'   },
    /* Descuentos */
    { id: 'pina-01',      name: 'Piña Oro Miel',    price: 3600,  unit: 'und', vendor: 'Finca el Porvenir',   img: '/static/img/piña.jpg',          tipo: 'Fruta',   descuento: 10, precioOriginal: 4000  },
    ...
    { id: 'papaya-01',    name: 'Papaya',           price: 1710,  unit: 'lb',  vendor: 'Finca el Porvenir',   img: '/static/img/papaya.jpg',        tipo: 'Fruta',   descuento: 10, precioOriginal: 1900  }
];
