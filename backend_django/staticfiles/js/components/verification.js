document.addEventListener('DOMContentLoaded', () => {
    ...
    if (wrapper) {
        ...
        const url = '/static/views/components/verification.html';
...
function initVerification() {
    ...
    form.addEventListener('submit', e => {
        ...
        setTimeout(() => {
            window.location.href = "/static/views/change_password.html";
        }, 1000);
    ...
    if (backBtn) {
        backBtn.addEventListener('click', () => {
            window.location.href = '/static/views/views_recover.html';
        });
    }
